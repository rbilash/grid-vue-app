<template>
    <div class="wrapper">
        <div class="grid">
            ...
            <row v-for="r in getRowNums" :key="r" :rownum="r" :colnum="getColNums"/>
        </div>
    </div>
</template>
...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            this.grid.rows = Math.ceil(height / 50);
            this.grid.cols = Math.ceil(width / 250);

            console.log('total rows', this.grid.rows);
